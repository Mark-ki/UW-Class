...
const MouseEffect: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (cursor && body) {
            body.setAttribute("style", "cursor: none !important;");
            document.addEventListener('mousemove', (e) => {
                ...
                body.prepend(effectEl);

                effectEl.style.left = cursor.getBoundingClientRect().x + "px";
                effectEl.style.top = cursor.getBoundingClientRect().y + "px";
